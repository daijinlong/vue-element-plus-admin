...
const schema = reactive<FormSchema[]>([
  ...
  },
  {
    ...
    componentProps: {
      placeholder: t('wanLi.inputToken')
    }
  },
  {
    field: 'field2',
    label: t('wanLi.orAccountAndPwd'),
    component: 'Divider'
  },
  {
    field: 'username',
    ...
    componentProps: {
      placeholder: t('wanLi.inputAccount')
    }
  },
  {
    field: 'password',
    ...
    componentProps: {
      ...
      placeholder: t('wanLi.inputPassword')
    }
  },
  {
    field: 'query_extract',
...
<template>
  <ContentWrap :title="t('router.wanLi')" :message="t('formDemo.wanLiArt')">
