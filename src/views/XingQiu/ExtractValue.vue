...
const schema = reactive<FormSchema[]>([
  ...
  },
  {
    ...
    componentProps: {
      placeholder: t('xingQiu.inputToken')
    }
  },
  {
    field: 'field2',
    label: t('xingQiu.orAccountAndPwd'),
    component: 'Divider'
  },
  {
    field: 'username',
    ...
    componentProps: {
      placeholder: t('xingQiu.inputAccount')
    }
  },
  {
    field: 'password',
    ...
    componentProps: {
      ...
      placeholder: t('xingQiu.inputPassword')
    }
  },
  {
    field: 'query_extract',
...
<template>
  <ContentWrap :title="t('router.xingQiu')" :message="t('formDemo.xingQiuArt')">
